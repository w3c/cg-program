...
* Our primary focus is on clarity of communications through the front / top of the document.
* We are not focused on the body of each specification (which is unchanged from the official version), but feedback on important issues is still welcome.

## Outcomes 

The outcomes we seek through the beta are:
