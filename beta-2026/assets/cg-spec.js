...
document.body.style.scrollPaddingTop = "" + (announcementBar.offsetHeight + 48) + "px";
...
function stickyAnnouncementDismiss() {
  ...
  document.body.style.scrollPaddingTop = "3rem"; // remove the scrollPaddingTop allowance for the announcement, by reverting to the default value
}
